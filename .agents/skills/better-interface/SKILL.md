...
A request naming a branch, pull request, commit range, or uncommitted changes is a change review. When the user has authorized that review, load `interface-review` directly and continue; do not ask them to repeat the request or type another skill name.
