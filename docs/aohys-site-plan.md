...
- Dashboard private API: React calls `/dashboard/api/*`; Cloudflare Pages validates auth/admin and proxies to Convex with the server-side dashboard token.
