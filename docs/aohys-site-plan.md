...
- Current proof and support assets: the Impeccable home direction now has a generated north-star mock at `docs/design/aohys-public-site-north-star.png`, the generated delivery-process artifact at `apps/site/public/images/generated/aohys-delivery-artifact.png`, the real AOHYS logo at `apps/site/public/images/brand/aohys-logo.png`, a production screenshot from Casa Roca, a sanitized Barber Central operations screenshot, a cropped Nutri Plan landing screenshot, and a custom AOHYS system map SVG under `apps/site/public/images/proof/`.
