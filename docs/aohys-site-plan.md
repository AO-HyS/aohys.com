...
- Current proof and support assets: the home proof surface now prioritizes the real AOHYS logo at `apps/site/public/images/brand/aohys-logo.png`, a production screenshot from Casa Roca, a sanitized Barber Central operations screenshot, a cropped Nutri Plan landing screenshot, and a custom AOHYS system map SVG under `apps/site/public/images/proof/`. Earlier generated artifacts remain in `apps/site/public/images/generated/` for reference only and are not the default public-page proof treatment.
